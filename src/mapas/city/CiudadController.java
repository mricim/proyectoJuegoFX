...
public class CiudadController extends PrimaryStageControlador implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
         ...
         */
        Image image = new Image(getClass().getResource("../../res/icons/example_casa.png").toExternalForm(), 100, 100, false, true);
        ImageView imageView = new ImageView(image);
        gridPaneMap.add(imageView, 7, 12);

        Image image2 = new Image(getClass().getResource("../../res/icons/example_academy.png").toExternalForm(), 100, 100, false, true);
        ImageView imageView2 = new ImageView(image2);
        gridPaneMap.add(imageView2, 12, 7);

        Image image3 = new Image(getClass().getResource("../../res/icons/example_empty.png").toExternalForm(), 100, 100, false, true);
